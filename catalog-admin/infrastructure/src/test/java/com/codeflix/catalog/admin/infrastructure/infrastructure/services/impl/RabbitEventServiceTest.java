package com.codeflix.catalog.admin.infrastructure.infrastructure.services.impl;

import com.codeflix.catalog.admin.domain.video.VideoMediaCreated;
import com.codeflix.catalog.admin.infrastructure.AmqpTest;
...
public class RabbitEventServiceTest {
    ...
    @Component
    static class VideoCreatedNewsListerner {
