...
import com.codeflix.catalog.admin.infrastructure.video.DefaultVideoGateway;
...
@IntegrationTest
@Import({DefaultVideoGateway.class})
@Transactional
public class DefaultVideoGatewayTest {
    ...
    public void givenAValidVideo_whenCallsCreate_shouldPersistIt() {
        ...
        Assertions.assertEquals(expectedMembers, persistedVideo.getMembersID());
