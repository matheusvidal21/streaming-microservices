...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthLessThan3_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String nameLentghLessThan3 = "Fi ";
        final var description = "A categoria mais assistida";
        final var isActive = true;
        final var expectedErrorCount = 1;
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String nameLentghLessThan3 = """
    ...
    public void givenAValidActiveCategory_whenCallDeactivate_thenShouldReturnCategoryInactivated() {
        ...
        Assertions.assertFalse(actualCategory.getUpdatedAt().isBefore(updatedAt));
        Assertions.assertNotNull(actualCategory.getDeletedAt());
    }
    ...
    @Test
    public void givenAValidCategory_whenCallUpdateWithInvalidParams_thenShouldReturnCategoryUpdated() {
